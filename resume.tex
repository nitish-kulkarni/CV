...
\begin{itemize} \itemenv
    ...
    \item \textbf{Data Scientist - Intern, DataSigns Technologies, Bengaluru } \hfill({\emph{Data Analytics and Credit Modeling}}) \itemyear{May - July 2017}
        \begin{itemize} \itemenv
            \item Revamped the credit model for underwriting loans to predict the likelihood of loan defaults
            \item Developed a scalable server architecture for processing of thousands of loan applications every day
    ...
    \item \textbf{Quantitative Analyst, Goldman Sachs, Bengaluru} \hfill (\emph{Fixed Income Strats, Investment Management Division}) \itemyear{June 2014 - Dec 2016}
        \begin{itemize} \itemenv 
            \item Predictive modeling \& autoregressive forecasting of economic indicators, Bayesian analysis of timeseries models
            \item Developed infrasture tools to perform analytics over large data and reflect real-time updates across multiple geographies
...
\begin{itemize} \itemenv
    \item \textbf{Statistical and time series analytics of investment portfolios} \itemyear{May - July 2017}
        \begin{itemize} \itemenv
            \item Developed a \textit{pandas}-based python toolkit for computing aggregated statistics and risk metrics for financial portfolios
